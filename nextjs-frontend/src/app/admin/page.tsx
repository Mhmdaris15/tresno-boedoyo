          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-600">
                {user?.coordinator?.firstName || user?.email} ({user?.role})
              </span>
              <Link 
                href="/dashboard"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage heritage preservation opportunities and volunteer applications
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Opportunity Management</h3>
              <svg className="w-6 h-6 text-heritage-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            ...
            <div className="space-y-3">
              ...
              <Link 
                ...
                className="block w-full border border-blue-600 text-heritage-600 py-2 px-4 rounded-lg hover:bg-blue-50 transition-colors text-center"
              >
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-3">
              ...
              <Link 
                ...
                className="block w-full border border-green-600 text-green-600 py-2 px-4 rounded-lg hover:bg-green-50 transition-colors text-center"
              >
                Manage Volunteers
              </Link>
            </div>
          ...
          <div className="p-6">
            <div className="space-y-4">
              <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">New opportunity "Borobudur Documentation" created</p>
              ...
              <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">3 new volunteer applications received</p>
              ...
              <div className="flex items-center space-x-3 p-3 bg-yellow-50 rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">Prambanan Conservation project deadline approaching</p>
              ...
              <div className="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">Traditional Batik Research project completed</p>
