    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-yellow-50">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            ...
            <span className="block text-blue-600">Cultural Heritage</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/about" className="border border-blue-600 text-blue-600 px-8 py-3 rounded-lg hover:bg-blue-50 font-medium">
              Learn More
            </Link>
          </div>
        </div>
      ...
      <section className="bg-blue-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/register" className="bg-white text-blue-600 px-8 py-3 rounded-lg hover:bg-gray-100 font-medium">
              Get Started Today
            </Link>
            <Link href="/about" className="border border-white text-white px-8 py-3 rounded-lg hover:bg-white hover:text-blue-600 font-medium">
              Learn More
            </Link>
          </div>
        </div>
